function calcular() {
    ...
    if (num1 < 0 || num2 < 0 || num3 < 0 || num1 > 10 || num2 > 10 || num3 > 10) {
        ...
        res.innerHTML = `Sua média é ${media.toFixed(1)} <br>Reprovado <img src="botao-x.png" width="25px">`
    } else {
        res.innerHTML = `Sua média é ${media.toFixed(1)} <br>Aprovado <img src="verifica.png" width="30px">`
    }
}
